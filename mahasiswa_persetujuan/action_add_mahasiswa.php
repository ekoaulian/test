...
$sqlID = "SELECT mahasiswa_id FROM mahasiswa_persetujuan ORDER BY mahasiswa_id DESC LIMIT 1";
$select = mysqli_query($koneksi, $sqlID);
$data = mysqli_fetch_assoc($select);
$myID = $data['mahasiswa_id'] + 1;

//input ke database
$sql = "INSERT INTO mahasiswa_persetujuan values($myID,'$mahasiswa_name','$tanggal','$tanggal',$IsActive)";
